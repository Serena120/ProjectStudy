...
import com.example.finalprojectstudyapp.databinding.ActivityNotesBinding
...
class NotesActivity : AppCompatActivity() {
    ...
    private fun uploadPdfFileToFirebase(){
        ...
        val mStorageRef = storageReference.child("${System.currentTimeMillis()}").child(fileName)
